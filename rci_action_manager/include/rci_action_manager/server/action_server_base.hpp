...
class ActionServerBase
{
  protected:
    ...
    std::shared_ptr<RobotController::SummitUR5Wrapper> mu_;
       
    ActionServerBase(std::string name, ros::NodeHandle &nh, std::shared_ptr<RobotController::SummitUR5Wrapper> &mu) :
